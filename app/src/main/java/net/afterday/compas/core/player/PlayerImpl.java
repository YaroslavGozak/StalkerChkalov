...
public class PlayerImpl implements Player
{
    ...
    private int[] InstantEffectsArray;
    private int[] DrugsEffectsArray;
    ...
    public PlayerImpl(Inventory inventory, Serializer serializer)
    {
        ...
        // Initial state for instant effects (0 - not activated, 1 - activated)
        InstantEffectsArray = new int[] { 0, 0, 0, 0, 0 };
        // Initial state for drugs (number of usages)
        DrugsEffectsArray = new int [] { 0, 0, 0, 0, 0 };
    }

    // Apply some influense???
...
//        FrameImpl frameImpl = new FrameImpl(mPlayerProps, delta);
    ...
    @Override
    public boolean instantEffect(INSTANTEFFECT iEffect)
    {
        switch (iEffect)
        {
            case ADDRAD1:
                mPlayerProps.addRadiation(1);
                o.addProperty("radiation", 1);
                break;
            case ADDRAD3:
                mPlayerProps.addRadiation(3);
                o.addProperty("radiation", 3);
                break;
            case ADDHEALTH10:
                mPlayerProps.addHealth(10);
                o.addProperty("health", 10);
                break;
            case ADDHEALTH20:
                mPlayerProps.addHealth(20);
                o.addProperty("health", 20);
                break;
            case ADDHEALTH30:
                mPlayerProps.addHealth(30);
                o.addProperty("health", 30);
                break;
            case REMOVERAD1:
                mPlayerProps.addRadiation(-1);
                o.addProperty("radiation", -1);
    ...
    @Override
    public boolean drugEffect(DRUGSEFFECT dEffect)
    {
