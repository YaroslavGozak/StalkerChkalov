...
public interface Player extends Jsonable
{
    ...
    enum STATE {
        ...
        public long getWaitTime()
        {
            switch (this)
            {
                ...
                case W_MENTALLED: return SEC30; //Мутация
                case W_CONTROLLED: return SEC30; // Мутация
                case W_DEAD_BURER: return MIN1; //Агония
                case W_DEAD_RADIATION: return MIN1; // Агония
                case W_DEAD_ANOMALY: return MIN1; // Агония
                case W_ABDUCTED: return MIN1; // Агония
                case ABDUCTED: return MIN30; //Плен
    ...
    boolean instantEffect(INSTANTEFFECT iEffect);
    boolean drugEffect(DRUGSEFFECT dEffect);
}
